...
//        }                         RongNotificationInterface
        PushNotificationMessage message1 = new PushNotificationMessage();
        message1.setConversationType(RongPushClient.ConversationType.SYSTEM);
        message1.setSourceType(PushNotificationMessage.PushSourceType.LOCAL_MESSAGE);
        message1.setPushTitle(title);
        RongNotificationInterface.sendNotification(context,message1);
        RongNotificationInterface notificationInterface = new RongNotificationInterface();
